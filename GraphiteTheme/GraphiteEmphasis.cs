...
{
    /// <summary>
    /// Font emphasis for the Graphite themes.
    /// </summary>
    /// <remarks>
    ...
    /// so it lives here instead of in the theme file.
    /// <para>
    ...
    /// That also means the emphasis applies under every theme, not just Graphite:
    ...
    /// </para>
    /// </remarks>
    internal static class GraphiteEmphasis
    {
        ...
        [Name("Graphite.TypeParameterName")]
        [UserVisible(false)]
        [Order(After = AfterDefaults)]
        ...
        [Name("Graphite.ExtensionMethodName")]
        [UserVisible(false)]
        [Order(After = AfterDefaults)]
        ...
        // means slanting every keyword — the trade-off this theme accepts.

        [Export(typeof(EditorFormatDefinition))]
        [ClassificationType(ClassificationTypeNames = "keyword")]
        [Name("Graphite.Keyword")]
        [UserVisible(false)]
        [Order(After = AfterDefaults)]
        ...
        [Name("Graphite.OverloadedOperator")]
        [UserVisible(false)]
        [Order(After = AfterDefaults)]
