...
function Get-CodePreviewLines {
    return @(
        ...
        @(@{ Text = '    {'; Kind = 'Text' }),
        @(@{ Text = '        private'; Kind = 'Keyword' }, @{ Text = ' readonly'; Kind = 'Keyword' }, @{ Text = ' List'; Kind = 'Class' }, @{ Text = '<'; Kind = 'Text' }, @{ Text = 'string'; Kind = 'Keyword' }, @{ Text = '>'; Kind = 'Text' }, @{ Text = ' _backing'; Kind = 'Property' }, @{ Text = ' ='; Kind = 'Operator' }, @{ Text = ' new'; Kind = 'Keyword' }, @{ Text = ' List'; Kind = 'Class' }, @{ Text = '<'; Kind = 'Text' }, @{ Text = 'string'; Kind = 'Keyword' }, @{ Text = '>();'; Kind = 'Text' }),
        ...
        @(@{ Text = '        public'; Kind = 'Keyword' }, @{ Text = ' string'; Kind = 'Keyword' }, @{ Text = ' Label'; Kind = 'Property' }, @{ Text = ' {'; Kind = 'Text' }, @{ Text = ' get'; Kind = 'Keyword' }, @{ Text = ';'; Kind = 'Text' }, @{ Text = ' init'; Kind = 'Keyword' }, @{ Text = '; } ='; Kind = 'Text' }, @{ Text = ' DefaultLabel'; Kind = 'Variable' }, @{ Text = ';'; Kind = 'Text' }),
        @(@{ Text = '        public'; Kind = 'Keyword' }, @{ Text = ' Emphasis'; Kind = 'Enum' }, @{ Text = ' Emphasis'; Kind = 'Property' }, @{ Text = ' {'; Kind = 'Text' }, @{ Text = ' get'; Kind = 'Keyword' }, @{ Text = ';'; Kind = 'Text' }, @{ Text = ' init'; Kind = 'Keyword' }, @{ Text = '; } ='; Kind = 'Text' }, @{ Text = ' Emphasis'; Kind = 'Enum' }, @{ Text = '.Italic;'; Kind = 'Text' }),
        @(@{ Text = ''; Kind = 'Text' }),
...
function Save-ThemePreview {
    ...
    try {
        ...
        $kindColors = @{
            ...
            Variable = $Palette.Variable; Property = $Palette.Property; Operator = $Palette.Operator
        ...
        foreach ($line in $codeLines) {
            ...
            foreach ($segment in $line) {
                $font = if ($segment.Kind -in 'Keyword', 'Method') { $boldFont } else { $normalFont }
...
function Invoke-GenerateMarketplaceAssets {
    ...
    $palettes = @(
        @{ Family = 'FocusThemes'; File = 'FocusVoltage'; Name = 'Focus Voltage'; Editor = '090B10'; Chrome = '0D1017'; Panel = '0B0E14'; Border = '102A31'; Text = 'D6E1F2'; Muted = '5A6A85'; Gutter = '556070'; Comment = '5A6A85'; Keyword = 'FF2E88'; Class = '3BE8FF'; Interface = '6FFFD1'; Record = 'B6FF3D'; Struct = 'FFD24D'; Enum = 'FF7A1A'; Method = '9B8CFF'; Variable = 'AEBED6'; Property = '6CEE58'; Operator = 'FF9EC4'; String = '6AA380'; Number = 'FFF275'; Accent = 'FF2E88'; IsLight = $false },
        @{ Family = 'FocusThemes'; File = 'FocusUltraviolet'; Name = 'Focus Ultraviolet'; Editor = '0B0714'; Chrome = '120C1F'; Panel = '0E0918'; Border = '2D1C3E'; Text = 'E4DAFF'; Muted = '6E5A8C'; Gutter = '64577D'; Comment = '6E5A8C'; Keyword = 'C77DFF'; Class = 'FF6EC7'; Interface = 'FFB3E3'; Record = '6BE1FF'; Struct = '5CFFB1'; Enum = 'FF9060'; Method = 'FFD166'; Variable = 'B7ABD4'; Property = '5884EE'; Operator = 'E0BFFF'; String = 'A1C38D'; Number = 'FFF3A3'; Accent = 'C77DFF'; IsLight = $false },
        @{ Family = 'FocusThemes'; File = 'FocusReactor'; Name = 'Focus Reactor'; Editor = '06100E'; Chrome = '0A1715'; Panel = '081310'; Border = '0C342B'; Text = 'D8F3EC'; Muted = '4E6E68'; Gutter = '49665F'; Comment = '4E6E68'; Keyword = 'FF7A1A'; Class = '2EF2C2'; Interface = '9FFFE3'; Record = 'A78BFA'; Struct = 'FF6EA9'; Enum = '63D8FF'; Method = 'FFE066'; Variable = 'A9C7C0'; Property = '5DEE58'; Operator = 'FFB27A'; String = 'B1C784'; Number = 'E8FF9E'; Accent = 'FF7A1A'; IsLight = $false },
        @{ Family = 'FocusThemes'; File = 'FocusArcade'; Name = 'Focus Arcade'; Editor = '0D0912'; Chrome = '150F1C'; Panel = '100B16'; Border = '391226'; Text = 'F2E9FF'; Muted = '6B5E7A'; Gutter = '625A6E'; Comment = '6B5E7A'; Keyword = 'FF3D7F'; Class = 'FFE94E'; Interface = 'FFF9C4'; Record = 'FF9F1C'; Struct = '3DFFC9'; Enum = 'C084FC'; Method = '4DA8FF'; Variable = 'C0B4D1'; Property = '58EE7A'; Operator = 'FF9CC0'; String = '9FC38C'; Number = 'D9FFB3'; Accent = 'FF3D7F'; IsLight = $false },
        @{ Family = 'FocusThemes'; File = 'FocusSignal'; Name = 'Focus Signal'; Editor = '101116'; Chrome = '16181F'; Panel = '13151B'; Border = '2A2B30'; Text = 'E6E8EF'; Muted = '6B7280'; Gutter = '5E616A'; Comment = '6B7280'; Keyword = 'FF5C39'; Class = '35C2FF'; Interface = '6E9BFF'; Record = 'C084FC'; Struct = '2DD4BF'; Enum = 'F472B6'; Method = 'FBBF24'; Variable = 'B4BAC7'; Property = '58EE6C'; Operator = 'FF9E85'; String = '6CA481'; Number = 'A3E635'; Accent = 'FF5C39'; IsLight = $false },
        @{ Family = 'FocusThemes'; File = 'FocusNightdive'; Name = 'Focus Nightdive'; Editor = '040F14'; Chrome = '08171D'; Panel = '061319'; Border = '103130'; Text = 'D2ECF2'; Muted = '4A6B75'; Gutter = '47636A'; Comment = '4A6B75'; Keyword = 'FF6B6B'; Class = '4DE1C1'; Interface = '4DF2A0'; Record = 'C6FF4D'; Struct = 'B39BFF'; Enum = 'FF9BD2'; Method = '59B8FF'; Variable = 'A3BFC7'; Property = '63EE58'; Operator = 'FFA8A8'; String = 'BDA87C'; Number = 'FFE3A8'; Accent = '4DE1C1'; IsLight = $false }
    )
